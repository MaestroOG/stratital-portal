        ...
        (<form action={formAction} className={cn("flex flex-col gap-6", className)} {...props}>
            ...
            <div className="grid gap-6">
                ...
                <div className="grid gap-3">
                    ...
                    <Input id="name" type="text" name="name" placeholder="e.g., John Doe" required className={'border border-gray-300'} />
                </div>

                <div className="grid gap-3">
                    <Label htmlFor="position" className={'text-heading'}>Position/Title</Label>
                    <Input id="position" type="text" name="position" placeholder="" required className={'border border-gray-300'} />
                </div>

                <div className="grid gap-3">
                    <Label htmlFor="phoneNum" className={'text-heading'}>Phone Number</Label>
                    <Input id="phoneNum" type="text" name="phoneNum" placeholder="Phone num.." required className={'border border-gray-300'} />
                </div>

                <div className="grid gap-3">
                    <Label htmlFor="contactEmail" className={'text-heading'}>Accounts Contact Email</Label>
                    <Input id="contactEmail" type="email" name="contactEmail" placeholder="contacts@example.com" required className={'border border-gray-300'} />
                </div>
                ...
                <div className="grid gap-3">
                    <Label htmlFor="abn" className={'text-heading'}>ABN (Austrailian Business Number)</Label>
                    <Input id="abn" type="number" name="abn" placeholder="" required className={'border border-gray-300'} />
                </div>

                <div className="grid gap-3">
                    <Label htmlFor="companyWebsite" className={'text-heading'}>Company Website</Label>
                    <Input id="companyWebsite" type="url" name="companyWebsite" placeholder="https://example.com" required className={'border border-gray-300'} />
                </div>

                <div className="grid gap-3">
                    <Label htmlFor="businessAddress" className={'text-heading'}>Business Address</Label>
                    <Input id="businessAddress" type="text" name="businessAddress" placeholder="" required className={'border border-gray-300'} />
                </div>

                <div className="grid gap-3">
                    <Label htmlFor="yearsInBiz" className={'text-heading'}>Years in Business</Label>
                    <Input id="yearsInBiz" type="number" name="yearsInBiz" placeholder="" required className={'border border-gray-300'} />
                </div>

                <div className="grid gap-3">
                    <Label htmlFor="numOfActiveClients" className={'text-heading'}>Approximate number of active clients</Label>
                    <Input id="numOfActiveClients" type="number" name="numOfActiveClients" placeholder="" required className={'border border-gray-300'} />
                </div>

                <div className="grid gap-3">
                    <Label htmlFor="socialMediaLinks" className={'text-heading'}>Social Media Links (if applicable)</Label>
                    <Textarea id="socialMediaLinks" name="socialMediaLinks" placeholder="" required className={'border border-gray-300'} />
                </div>
                ...
                <div className="grid gap-3">
                    ...
                    <Textarea id="primaryServices" name="primaryServices" placeholder="" required className={'border border-gray-300'} />
                </div>

                <div className="grid gap-3">
                    <Label htmlFor="industriesWorkWith" className={'text-heading'}>Industries You Commonly Work With</Label>
                    <Textarea id="industriesWorkWith" name="industriesWorkWith" placeholder="" required className={'border border-gray-300'} />
                </div>

                <div className="grid gap-3">
                    <Label htmlFor="regionsServe" className={'text-heading'}>Regions You Serve</Label>
                    <Textarea id="regionsServe" name="regionsServe" placeholder="" required className={'border border-gray-300'} />
                </div>
                ...
                <div className="grid gap-3">
                    ...
                    <Input id="monthlyProjectVolume" type="text" name="monthlyProjectVolume" placeholder="" required className={'border border-gray-300'} />
                </div>
